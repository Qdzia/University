...
namespace SSI.ANN
{
    class Neuron
    {
        ...
        {
            var synapse = new Synapse(inputNeuron, this as INeuron); // poprawka
            Inputs.Add(synapse);
            inputNeuron.Outputs.Add(synapse);
        }
        public void AddOutputNeuron(INeuron outputNeuron)
        {
            var synapse = new Synapse(this as INeuron, outputNeuron); // poprawka
            Outputs.Add(synapse);
        ...
        {
            var inputSynapse = new InputSynapse(this as INeuron, inputValue);
